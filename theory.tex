...
\begin{itemize}
    ...
    \item \textbf{Michal Szewczak -- 25\%}: preparation of the introduction and
    user-oriented descriptive parts of the report, in particular the user guide
    and the presentation of how the application is used.
    \item \textbf{Sebastian Trojan -- 25\%}: implementation of the compiler and
    executable application, together with the technical description of the adopted
